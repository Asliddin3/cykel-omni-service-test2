...
type Config struct {
	...
	LockPort         string
	LockHost         string
	LockerServiceHost string
	LockerServicePort string
}
...
func Load() Config {
	...
	c.LockerServiceHost = cast.ToString(getOrReturnDefault("ADMIN_HOST", "localhost"))
	c.LockerServicePort = cast.ToString(getOrReturnDefault("ADMIN_PORT", "8088"))
